...
{
    public class ZombieSoundDecorator : GameSoundDecorator
    {
        private AudioFileReader _audioFileReader;
        private WaveOutEvent _outputDevice;
        private string _soundsPath = "~/Assets/Sounds/";

        public ZombieSoundDecorator(IGameSound gameSound, string soundFile) : base(gameSound) 
        {
        ...
        {
            _outputDevice.Stop();
            _audioFileReader.Position = 0; // Resets zombie sound effect to the beginning
        }
