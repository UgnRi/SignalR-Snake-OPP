...
{
    public class LightningSoundDecorator : GameSoundDecorator
    {
        private AudioFileReader _audioFileReader;
        private WaveOutEvent _outputDevice;
        private string _soundsPath = "~/Assets/Sounds/";

        public LightningSoundDecorator(IGameSound gameSound, string soundFile) : base(gameSound)
        {
        ...
        {
            _outputDevice.Stop();
            _audioFileReader.Position = 0; // Resets lightning sound effect to the beginning
        }
