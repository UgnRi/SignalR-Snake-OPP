...
{
    public class CreeperSoundDecorator : GameSoundDecorator
    {
        private AudioFileReader _audioFileReader;
        private WaveOutEvent _outputDevice;
        private string _soundsPath = "~/Assets/Sounds/";

        public CreeperSoundDecorator(IGameSound gameSound, string soundFile) : base(gameSound)
        {
        ...
        {
            _outputDevice.Stop();
            _audioFileReader.Position = 0; // Resets creeper sound effect to the beginning
        }
