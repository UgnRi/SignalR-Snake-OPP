...
{
    public class LongSnakeFactory : SnakeFactory
    {
        public override SnakeBuilder CreateSnakeBuilder(string name)
        {
            ...
            var parts = GetLongSnakeParts(start, color, name);
        ...
        private List<SnekPart> GetLongSnakeParts(Point start, string color, string name)
        {
