...
{
    public class TriangleSnakeFactory : SnakeFactory
    {
        public override SnakeBuilder CreateSnakeBuilder(string name)
        {
            ...
            var parts = GetTriangleSnakeParts(start, color, name);
        ...
        private List<SnekPart> GetTriangleSnakeParts(Point start, string color, string name)
        {
